...
# 设置输入和输出文件夹
input_image_dir = r'D:\PyCharm\pytorch\UNet-LiTS2017-main\LiTS\volumes'  # 输入图像文件夹
input_label_dir = r'D:\PyCharm\pytorch\UNet-LiTS2017-main\LiTS\segmentations'  # 输入标签文件夹
output_dir = r'D:\PyCharm\pytorch\UNet-LiTS2017-main\LiTS\LiTS'  # 输出切片保存文件夹
